                ...
                <form action="{{ route('question.store') }}" method="post">
                  @csrf
                   ...
                   <div class="form-group {{ $errors->has('topics') ? 'focused error' : '' }}">
                    ...
                    <div class="form-group {{ $errors->has('qsn_types') ? 'focused error' : '' }}">
                        <label class="col-form-label">Select qsn_types</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="html-editor" name="qsn_title"></div>
                     
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Deafult Point</label>
                        <input type="text" name="topic_name" class=" form-control" id="exampleInputEmail1" required>
