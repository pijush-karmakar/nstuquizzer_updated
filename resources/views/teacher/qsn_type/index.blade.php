...
@section('title','Question Type  List')
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="breadcomb-wp">
                    ...
                    <div class="breadcomb-ctn">
                        ...
                        <p>Question Type  list , Add & Edit Question Type </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                <div class="breadcomb-report">
                      <a class="float-right btn btn-sm btn-success admin-btn" href="{{route('type.create')}}" >Add New Question Type </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                              <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                         @foreach ($qsn_types as $type)
                            
                            <tr>

                              

                                <td>{{ $type->qsn_type_name }}</td>

                                <td>
                                    <ul class="d-flex justify-content-center">
                                        <li class="mr-3"><a href="{{route('type.edit',[$type->id])}}" class="text-secondary"><i class="notika-icon notika-edit"></i></a></li>

                                        <li class="mr-3"><a href="#" class="text-danger" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $type->id }}').submit();" ><i class="notika-icon notika-trash"></i></a></li>
                        ...
                        <tr>
                            @if($qsn_types->count()==0)
                           <td>No qsn_type is available or created Yet...</td>
                            @endif
                        </tr>                                    
