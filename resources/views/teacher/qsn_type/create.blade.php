...
@section('content')
    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">ADD New Question Type</h4>
                ...
                <form action="{{ route('type.store') }}" method="post">
                  @csrf
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Question Type Name</label>
                        <input type="text" name="qsn_type_name" class="form-control" id="exampleInputEmail1" required>
