        ...
        <div class="card-body">
            ...
            <form action="{{ route('course.store') }}" method="post">
                ...
                <p>
                    ...
                    You will be a course teacher by default.
                </p>

                <div class="form-group {{ $errors->has('teachers') ? 'focused error' : '' }}">
                    <label class="col-form-label">Select another course teacher</label>
                    <select multiple class="form-control" name="teachers[]" required="">

                        @foreach($teachers as $teacher)
                        @if ($teacher->id == Auth::guard('teacher')->user()->id)
                        <option class="hidden" selected value="{{ $teacher->id }}">{{ $teacher->name }}</option>
                        @else
