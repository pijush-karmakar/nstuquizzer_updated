...
@section('content')
    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">ADD New Test</h4>
                ...
                <form action="{{ route('test.store') }}" method="post">
                  @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="test_name" class="form-control" id="exampleInputEmail1" required>
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">Store</button>
                     <a href="{{ route('test.index') }}" class="btn btn-sm btn-danger float-right">Back</a>
